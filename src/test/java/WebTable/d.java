	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(;;)//1 2 3 4 5
		{
			...
			{ //not visible - exception - visible - click()
				//driver.findElement(By.xpath("//div[@aria-label='Sat Mar 02 2024']")).click(); // No such element exception
				driver.findElement(By.xpath("//div[@class='DayPicker-Months']/descendant::div[@aria-label='Thu Jan 04 2024']")).click();
				break;
			} 
			catch (Exception e) 
			{//click on next month
		...
		try {
			driver.findElement(By.xpath("//div[@aria-label='Fri Mar 01 2024']")).click();
		} catch (Exception e) {
