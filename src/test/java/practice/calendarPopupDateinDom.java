...
public class calendarPopupDateinDom {
...
////		WebElement dropdown=driver.findElement(By.xpath("//input[@class='react-autosuggest__input react-autosuggest__input--open']"));
...
//		String calYear=driver.findElement(By.xpath("//div[text()='2023')]")).getText();
//		String calMonth=driver.findElement(By.xpath("//div[text()='December')]")).getText();
//		while(!calYear.equals(year)&& calMonth.equals(calMonth)){
//			calMonth=driver.findElement(By.xpath("//div[text()='December')]")).getText();
//			calYear=driver.findElement(By.xpath("//div[text()='2023')]")).getText();
